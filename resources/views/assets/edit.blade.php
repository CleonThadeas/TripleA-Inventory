<x-app-layout>
    <div class="max-w-4xl mx-auto px-6 py-6 space-y-10">
        ...
        <form method="POST"
            ...
            <h3 class="font-semibold">Tambah Komponen (Manual)</h3>
        ...
        <form method="POST"
            ...
            <h3 class="font-semibold">Tambah Komponen (Deskripsi)</h3>

            <p class="text-sm text-gray-600">
                Format: <b>KEY : VALUE</b> (1 baris = 1 komponen)
            </p>
